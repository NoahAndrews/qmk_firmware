...
#define CLOSEW LALT(KC_F4)                // Close window
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  '   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Brite|  GUI |  Alt | Ctrl | Lower| Shift| Space| Raise| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 *                                              ^
 *                                    Hold for mouse keys 
 */
[_QWERTY] = {
  ...
  {BACKLIT, KC_LGUI, KC_LALT, KC_LCTL, LOWER,   KC_LSFT, MOUSPACE, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
...
[_QWERTY_MAC] = {
  ...
  {KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT},
  {KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT },
  {M(0),    KC_LCTL, KC_LALT, KC_LGUI, MO(_LOWER), KC_LSFT,  LT(_MOUSEKEYS,KC_SPC),  MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
 ...
 * |      |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |   _  |   +  |   {  |   }  |  |   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |PrtScr|  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |      | Close|      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Home | PgDn | PgUp | End  |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = {
  ...
  {KC_PSCR, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, CLOSEW,  _______, _______, _______},
